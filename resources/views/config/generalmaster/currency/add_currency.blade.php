            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Currency Id<span
                                        class="text-danger">
                                        *</span></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name='GMCRHDesc2' id='GMCRHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMCRHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
