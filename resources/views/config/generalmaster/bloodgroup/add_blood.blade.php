@extends('layouts.app')
@section('page_title', 'Add Blood Group')
@section('content')
@section('css')
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Blood Group Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMBGHBloodGroupId' id='GMBGHBloodGroupId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Blood Group Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMBGHBloodGroupId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="GMBGHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMBGHDesc1' id='GMBGHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMBGHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='GMBGHBiDesc' id='GMBGHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMBGHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='GMBGHDesc2' id='GMBGHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMBGHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        $('#AddForm')[0].reset();
                        custom_notification({
                            text: 'Blood Group Added successfully',
                            pos: 'bottom-right',
                            duration: 100000
                        })
                    }
