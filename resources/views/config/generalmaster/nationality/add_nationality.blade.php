@extends('layouts.app')
@section('page_title', 'Add Nationality')
@section('content')
@section('css')
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Nationality Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMNAHNationalityId' id='GMNAHNationalityId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Nationality Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMNAHNationalityId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="GMNAHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMNAHDesc1' id='GMNAHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMNAHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='GMNAHBiDesc' id='GMNAHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMNAHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='GMNAHDesc2' id='GMNAHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMNAHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
