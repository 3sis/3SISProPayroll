@extends('layouts.app')
@section('page_title', 'Add Salutation')
@section('content')
@section('css')
    ...
    <div class="container">
        <div class="row layout-top-spacing">
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h4>Add Salutation</h4>
                    </div>
                    <div class="widget-content widget-content-area">

                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Salutation Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMSLHSalutationId' id='GMSLHSalutationId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Salutation Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMSLHSalutationId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="GMSLHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMSLHDesc1' id='GMSLHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMSLHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='GMSLHBiDesc' id='GMSLHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMSLHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='GMSLHDesc2' id='GMSLHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMSLHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        $('#AddForm')[0].reset();
                        custom_notification({
                            text: 'Salutation Added successfully',
                            pos: 'bottom-right',
                            duration: 100000
                        })
                    }
