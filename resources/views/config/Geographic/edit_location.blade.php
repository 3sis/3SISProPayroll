                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name='GMLMHDesc2' id='GMLMHDesc2' class='form-control textarea' maxlength="200" placeholder="Enter Location Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMLMHDesc2', $location['GMLMHDesc2'] ?? '') }}</textarea>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select id='GMLMHCityId' name='GMLMHCityId' class="form-select" style="width: 100%;border: 1px solid #68a6ec;">
                                    ...
                                    @if (!empty($location['GMLMHCityId']) && $location['GMLMHCityId'] == $city->GMCTHCityId)
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="GMLMHStateId" id="GMLMHStateId" value="{{ $location->GMLMHStateId }}">
                                <input type="text" name='stateName' id='stateName' class='form-control' value="{{ $location->fnState->GMSMHDesc1 }}" readonly>
                            </div>

                            <div class="col-md-4">
                                <label for="validationDefault05" class="form-label">Contry</label>
                                <input type="hidden" name="GMLMHCountryId" id="GMLMHCountryId" value="{{ $location->GMLMHCountryId }}">
                                <input type="text" name='countryName' id='countryName' class='form-control' value="{{ $location->fnCountry->GMCMHDesc1 }}" readonly>
                            </div>
