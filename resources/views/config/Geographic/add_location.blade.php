                     ...
                     @csrf
                        <div class="row m-2">
                            ...
                            <button class="btn btn-danger _effect--ripple waves-effect waves-light error_btn mx-2" data-bs-toggle="modal" data-bs-target="#ErrorListModalCenter">Error</button>
                                ...
                                <button class="btn btn-success _effect--ripple waves-effect waves-light mx-2" type="submit">Save</button>
                    ...
                    <div class="widget-content widget-content-area">
                            ...
                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Location Id<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='GMLMHLocationId' id='GMLMHLocationId' class='form-control threshold' maxlength="20" placeholder="Enter Location Name" style='border-color: rgb(102, 175, 233); outline: 0px' value="{{ old('GMLMHLocationId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="GMLMHDesc1" class="form-label">Description 1<span class="text-danger"> *</span></label>
                                <input type="text" name='GMLMHDesc1' id='GMLMHDesc1' class='form-control threshold' maxlength="20" placeholder="Enter Location Description 1" style='border-color: rgb(102, 175, 233); outline: 0px' value="{{ old('GMLMHDesc1') }}">

                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='GMLMHDesc2' id='GMLMHDesc2' class='form-control textarea' maxlength="200" placeholder="Enter Location Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMLMHDesc2') }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="validationDefault04" class="form-label">City<span class="text-danger"> *</span></label>
                                <select id='GMLMHCityId' name='GMLMHCityId' class="form-select" style="width: 100%;border: 1px solid #68a6ec;">
