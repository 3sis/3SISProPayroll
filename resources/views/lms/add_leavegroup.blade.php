@extends('layouts.app')
@section('page_title', 'Add Leave Group')
@section('content')
@section('css')
    ...
    <div class="container">
        <div class="row layout-top-spacing">
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h4>Add Leave Group</h4>
                    </div>
                    <div class="widget-content widget-content-area">

                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Leave Group Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='LMLGHGroupId' id='LMLGHGroupId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Leave Group Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('LMLGHGroupId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="LMLGHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='LMLGHDesc1' id='LMLGHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Leave Group Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('LMLGHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='LMLGHBiDesc' id='LMLGHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('LMLGHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='LMLGHDesc2' id='LMLGHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Leave Group Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('LMLGHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
