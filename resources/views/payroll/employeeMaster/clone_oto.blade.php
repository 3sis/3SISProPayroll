@extends('layouts.app')
@section('page_title', 'Employee Clone')
@section('content')
@section('css')
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                <label for="validationDefault04" class="form-label">Old Employee<span class="text-danger">
                                        *</span></label>
                            ...
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">New Employee Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='NewEmployeeId' id='NewEmployeeId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter New Employee Id"
                            ...
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">First Name<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='NewEmployeeFirstName' id='NewEmployeeFirstName'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Employee First Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'>
                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Middle Name</label>
                                <input type="text" name='NewEmployeeMiddleName' id='NewEmployeeMiddleName'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Employee Middle Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'>
                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Last Name</label>
                                <input type="text" name='NewEmployeeLastName' id='NewEmployeeLastName'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Employee Last Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'>
                            </div>
                            <div class="col-12">
                                <!-- Modal -->
...
<script type="text/javascript">
    ...
    $("#AddForm").submit(function(e) {
        e.preventDefault();
        $('#NewEmployeeId,#EMGIHEmployeeId').removeClass('border border-danger');

        if ($('#NewEmployeeId').val() == '') {
            $('#NewEmployeeId').addClass('border border-danger');
        }
        ...
        if ($('#NewEmployeeId').val() == '' || $('#EMGIHEmployeeId').val() == '') {
            if ($('#NewEmployeeId').val() == '') {
                $('.form_error_list').append('<p>Please Enter New Employee Code !</p>');
            }
            if ($('#EMGIHEmployeeId').val() == '') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        $('#AddForm')[0].reset();
                        custom_notification({
                            text: 'Employee Clone successfully',
                            pos: 'bottom-right',
                            duration: 100000
                        })
                    }
