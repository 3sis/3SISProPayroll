            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Department Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESDPHDepartmentId' id='ESDPHDepartmentId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Department Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESDPHDepartmentId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="ESDPHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESDPHDesc1' id='ESDPHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Department Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESDPHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='ESDPHBiDesc' id='ESDPHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESDPHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='ESDPHDesc2' id='ESDPHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Department Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('ESDPHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'error') {
                        // Bottom Right
                        custom_notification({
                            text: 'Department Master not save',
                            pos: 'bottom-right'
                        })
                    }
                }
