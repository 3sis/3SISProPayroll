            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Designation Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESDEHDesignationId' id='ESDEHDesignationId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Designation Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESDEHDesignationId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="ESDEHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESDEHDesc1' id='ESDEHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Designation Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESDEHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='ESDEHBiDesc' id='ESDEHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESDEHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='ESDEHDesc2' id='ESDEHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Designation Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('ESDEHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
