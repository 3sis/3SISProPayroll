            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Grade Id<span
                                        class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESGRHGradeId' id='ESGRHGradeId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Grade Name"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESGRHGradeId') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="ESGRHDesc1" class="form-label">Description 1<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESGRHDesc1' id='ESGRHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Grade Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESGRHDesc1') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc</label>
                                <input type="text" name='ESGRHBiDesc' id='ESGRHBiDesc'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('ESGRHBiDesc') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='ESGRHDesc2' id='ESGRHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Grade Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('ESGRHDesc2') }}</textarea>
                            </div>
                            <div class="col-12">
