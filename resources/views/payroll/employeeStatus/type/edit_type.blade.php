                     ...
                     <input type="hidden" value="{{$type['id']}}" name="id">
                        <div class="row m-2">
                            ...
                            <button class="btn btn-danger _effect--ripple waves-effect waves-light error_btn mx-2 bs-tooltip" data-bs-placement="bottom" title="Error" data-bs-toggle="modal" data-bs-target="#ErrorListModalCenter">Error</button>
                                <a href="{{route('type')}}" class="btn btn-info _effect--ripple waves-effect waves-light bs-tooltip" data-bs-placement="bottom" title="Back" type="submit">Back</a>
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                            ...
                            <div class="row g-3">
                            <div class="col-md-3">
                                <label for="validationDefault01" class="form-label">Type Id<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESTYHTypeId' id='ESTYHTypeId' class='form-control threshold' maxlength="20" placeholder="Enter Type Name" style='border-color: rgb(102, 175, 233); outline: 0px' value="{{ old('ESTYHTypeId', $type['ESTYHTypeId'] ?? '') }}" readonly="readonly">
                            </div>
                            <div class="col-md-6">
                                <label for="ESTYHDesc1" class="form-label">Description 1<span class="text-danger"> *</span></label>
                                <input type="text" name='ESTYHDesc1' id='ESTYHDesc1' class='form-control threshold' maxlength="20" placeholder="Enter Type Description 1" style='border-color: rgb(102, 175, 233); outline: 0px' value="{{ old('ESTYHDesc1', $type['ESTYHDesc1'] ?? '') }}">

                            </div>
                            <div class="col-md-3">
                                <label for="validationDefault05" class="form-label">BI Desc<span class="text-danger">
                                        *</span></label>
                                <input type="text" name='ESTYHBiDesc' id='ESTYHBiDesc' class='form-control threshold' maxlength="20" placeholder="Enter Bi Desc" style='border-color: rgb(102, 175, 233); outline: 0px' value="{{ old('ESTYHBiDesc', $type['ESTYHBiDesc'] ?? '') }}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault03" class="form-label">Description 2</label>
                                <textarea name='ESTYHDesc2' id='ESTYHDesc2' class='form-control textarea' maxlength="200" placeholder="Enter Type Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('ESTYHDesc2', $type['ESTYHDesc2'] ?? '') }}</textarea>
                            </div>
